            ...
            <nav className={styles.navigation}>
                <ul className={styles.menu}>
                    <li className={`${styles.menuItem} pt-4 pb-4 pr-5 pl-5`}>
                        <Link className={styles.menuLink} to={routes.main}>
                    ...
                    <li className={styles.menuItem}>
                        <Link className={`text text_type_main-default text_color_inactive ${styles.menuLink}`} to={routes.feed}>
                ...
                <ul className={styles.menu}>
                    <li className={`pt-4 pb-4 pr-5 pl-5 ${styles.profile}`}>
                        <Link className={styles.menuLink} to={routes.profile}>
