import {
    ...
    WS_SOCKET_ERROR, WS_SOCKET_ONMESSAGE, WS_SOCKET_ONMESSAGE_PRIVAT, TSocketActions
...
export const webSocketReducer = (state = initialState, action: TSocketActions): IState => {
    switch (action.type) {
        case WS_SOCKET_OPEN:
