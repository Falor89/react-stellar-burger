import { loginRequest, register, getUser, logoutRequest, setUserRequest, refreshRequest } from "../../utils/api";
import { setCookie, getCookie, deleteCookie } from "../../utils/cookie";
import { TUser, TAuthResponse, TSetUserRequest } from "../../utils/types/data";
    ...
    return function (dispatch) {
        ...
        return loginRequest(email, password)
            .then((data) => {
                ...
                setCookie('tokenToRefresh', data.refreshToken);
            })
            .catch((err) => {
                dispatch({
                    type: LOGIN_ERROR,
