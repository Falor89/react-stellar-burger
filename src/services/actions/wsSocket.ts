import { TOrder, ISocketResponse } from "../../utils/types/data";

export const WS_SOCKET_OPEN = 'WS_SOCKET_OPEN';
export const WS_SOCKET_OPEN_PRIVAT = 'WS_SOCKET_OPEN_PRIVAT';
...
export const WS_SOCKET_ONMESSAGE_PRIVAT = 'WS_SOCKET_ONMESSAGE_PRIVAT';
...
interface ISocketOpenPrivateAction {
    readonly type: typeof WS_SOCKET_OPEN_PRIVAT;
}
...
interface ISocketOnmessagePrivateAction {
    readonly type: typeof WS_SOCKET_ONMESSAGE_PRIVAT;
...
export interface IWsActions {
    ...
    readonly openPrivate: typeof WS_SOCKET_OPEN_PRIVAT;
    readonly onMessagePrivate: typeof WS_SOCKET_ONMESSAGE_PRIVAT;
}
